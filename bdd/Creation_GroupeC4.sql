...
/* SUPPRESSION DE L'ATTRIBUT 'ADRESSE' DANS LA TABLE 'EVENEMENT' REMPLACÉ PAR 2 ATTRIBUTS : 'LATITUDE' ET 'LONGITUDE' => RETRAIT DU BLOC DE CODE DU TRIGGER (INSERT/UPDATE) MANIPULANT L'ADRESSE */
/*************************************************************************************************************************************************************************************************************************/
...
CREATE TABLE EVENEMENT(
    ...
    PseudoC VARCHAR(20),
    Latitude DECIMAL(10, 8) CHECK (Latitude IS NOT NULL),
    Longitude DECIMAL(11, 8) CHECK(Longitude IS NOT NULL),
